...
func TestPop(t *testing.T) {
	...
	if m.Count() != 0 {
		t.Error("Expecting count to be zero once item was Popped.")
	}
...
func TestConcurrent(t *testing.T) {
	...
	// Using go routines insert 1000 int into our map.
	go func() {
...
func TestFnv32(t *testing.T) {
	...
	if fnv32(string(key)) != hash.Sum32() {
		t.Errorf("Bundled fnv32 produced %d, expected result from hash/fnv32 is %d", fnv32(string(key)), hash.Sum32())
	}
}
