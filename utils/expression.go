...
func If[T any](boolExpression bool, trueReturnValue, falseReturnValue T) T {
	if boolExpression {
...
//	@return bool: 三元表达式的结果，为trueReturnValue或者falseReturnValue中的一个
func IfByFunc[T any](boolExpression bool, trueFuncForReturnValue, falseFuncForReturnValue func() T) T {
	if boolExpression {
